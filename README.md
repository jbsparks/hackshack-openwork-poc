...
Short screencasts of the labs at 2x speed. Click a thumbnail to download the video.

### Web UI walkthrough (2x speed, 698 KB)

[![Web UI demo](recordings/hackshack-web-thumb.png)](recordings/hackshack-demo-2x.mp4?raw=true)

### CLI walkthrough (2x speed, asciinema)

![CLI demo](recordings/hackshack-cli-demo.gif)

> [Download the .cast file](recordings/hackshack-cli-demo.cast?raw=true) for `asciinema play` locally.
> 1x speed web recording: [hackshack-demo.mp4 (7 MB)](recordings/hackshack-demo.mp4?raw=true)
